...
import './RegisterJWTAdvice.css';
import { cpf, cnpj } from 'cpf-cnpj-validator';

const RegisterJWTAdvice: FC = (props) => {
  ...
  return (
    <div className="RegisterAdviceForm">
      <Formik
        innerRef={formikRef}
        initialValues={{
          email: '',
      ...
      >
        {(formikProps) => (
          ...
          <Form
            ...
            {...props}
          >
            <h2 className="RegisterJWTAdviceLabel">CADASTRO DE ASSESSORIA</h2>
            <InputCustom
              type="email"
              name="userName"
...
export default RegisterJWTAdvice;
